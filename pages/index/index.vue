<template>
  <view class="content">
    ...
    <!-- <uni-section title="自定义icon" type="line" :radius="100">
      <uni-search-bar placeholder="自定义" @confirm.stop="search" @cancel="cancel" cancel-text="搜索">
        <uni-icons slot="searchIcon" color="#999999" size="18" type="camera" @click.stop="test" />
      </uni-search-bar>
    </uni-section> -->
    <!-- </view>	 -->
    ...
    <view class="order-class">
      <view class="order-class-item" @click="addOrder(1)"><image src="/static/images/index1.png" mode="aspectFill"></image></view>
      <view class="order-class-item" @click="addOrder(2)" style="margin-left: 8upx;"><image src="/static/images/index2.png" mode="aspectFill"></image></view>
    </view>
    <view class="order-class">
      <view class="order-class-item" @click="addOrder(3)"><image src="/static/images/index3.png" mode="aspectFill"></image></view>
      <view class="order-class-item" @click="addOrder(4)" style="margin-left: 8upx;"><image src="/static/images/index4.png" mode="aspectFill"></image></view>
    </view>
    <view class="cu-reclaimss" @click="quiz()">
